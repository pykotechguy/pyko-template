<div class="container-fluid content-fluid">				    	
    ...
    <div class="row-fluid" style="margin-top: 20px;">
        ...
        <div class="span12">					    		
            <form class="form-horizontal" type="">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea rows="5" class="span3 datepicker" value="" >
			</textarea>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">Specific Technologies </label>
                    <div class="controls">
                        <input type="text" class="span3r" name="technologies" placeholder="ruby,python,html,css"/>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">Estimated Start Date </label>
                    <div class="controls">
	                     <input type="text"  class="span datepicker" /a
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">RFP Upload (optional)</label>
                    <div class="controls">
                        <input type="text" class="span3" value="" />
                    </div>
                </div>
