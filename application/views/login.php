...
<html lang="en">
  <head>
    ...
    <link href="<?=base_url()?>bootstrap/css/bootstrap.css" rel="stylesheet">
		<link rel="stylesheet" href="<?=base_url()?>assets/css/frontanimations.css">
...
body {background-color: #2980B9}
 ...
 <div id="object" class="fadeIn">
      ...
      <div class="demo-headline">
       ...
       <img src="<?=base_url()?>assets/images/login/bann.png" alt="Welcome to Mail App" /><br>
  <img src="<?=base_url()?>assets/images/login/mmc.png" alt="Welcome to Mail App" />
     <div class="container">
      <div class="login">
        <div class="login-screen">
          ...
          <center><div class="login-form">
            ...
            <a class="btn btn-primary btn-large btn-block" href="<?=site_url()?>/dashboard">Login</a>
